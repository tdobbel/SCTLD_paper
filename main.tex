...
% * DH "the proportion of infected corals that colonies can sustain before the development of an outbreak." This isn't a very clear definition of the "threshold". Consider revising?
...
% * <Lew Gramer - NOAA Affiliate> 09:22:11 28 May 2020 UTC-0400:
% Doesn't this first sentence kind of presume one of our main hypotheses - that motile organisms and human activity are not primary drivers? May be worth weakening... Also, this initial text sounds more like Introduction than Methods to me, maybe?
...
Transmission and removal parameters of $\sigma$ and $\beta_0'$ are fitted to disease prevalence observations averaged over all colonies from all monitored sites in the FRT in order to accurately simulate the temporal evolution of $S_j,I_j,R_j$ on each infected reef polygon. \erinn{[Could you provide some details on these data prevalence observations ?]}
