...
These connectivity matrices can be more easily handled by interpreting them as large graphs whose vertices are reefs. Such networks can then be analyzed using graph theory tools. In this study, 5 potential connectivity measures are used to interpret our monthly computed networks. These indicators are summarize in Table \ref{tab:indicator}
...
\begin{table}
    ...
    \begin{tabular}{|p{4cm}|p{5cm}|p{4cm}|}
        ...
        \hline
            ...
            Efficiency of potential disease spread  \\
        \hline
            Fraction lost &
            Fraction of infectious material produced on a reef that does not settle on any other reef &
            Efficiency of potential disease spread \\
        \hline
            Isolation &
            Fraction of infectious material settling on a given reef that has been released on another reef &
            Potential for disease to spread on a given reef \\
        \hline            
    \end{tabular}
...
\textcolor{blue}{[describe results of figure \ref{fig:results} as much as possible]}
