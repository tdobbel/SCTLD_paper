...
\textcolor{blue}{Discussion over method used to compute front speed ? (largest distance between two fronts $\Rightarrow$ potentially overestimating front speed compared to Erinn's paper)}
