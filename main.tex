...
% * DH - Feel free to edit this text.
...
% * <emmanuel.hanert@uclouvain.be> 09:18:04 28 May 2020 UTC+0200:
% For the out-degree, I would consider the (number of connections) x (amount of material exchanged). That's a better measure of a reef's potential to spread the disease.
...
population ($R_0 > 1$) or not ($R_0 < 1$). The obtained basic reproduction number is then used to find the value of $\beta'_0$ that reproduces the observed temporal evolution of the state of the coral colonies. Finally, the value of $\sigma$ is obtained from the value of $\beta_0'$ using the expression of $R_0$.
% * <emmanuel.hanert@uclouvain.be> 09:23:19 28 May 2020 UTC+0200:
% It's still not clear to me how you find the value of sigma...
...
% * <emmanuel.hanert@uclouvain.be> 09:27:54 28 May 2020 UTC+0200:
% consider out-degree as (# connections)x(amount of material exchanged) and revise description
...
% * <emmanuel.hanert@uclouvain.be> 09:30:36 28 May 2020 UTC+0200:
% Your description of self recruitment is not clear to me...
...
% * <emmanuel.hanert@uclouvain.be> 09:43:03 28 May 2020 UTC+0200:
% Not clear to me what you mean by "balance each other as scenarios that overestimate the front speed are more likely to predict infection near monitored reefs."
